...
Class 0 Attester freshness handling follows procedure as documented in {{!RFC9334, Section 10}}.
For Class 1 Composite Attester, the Lead Attester, recieves the freshness parameter from the Verifer.
Lead Attester conveys the same freshness parameter to the Component Attesters.
This ensures the same freshness parameter is included in each of the Component Evidences.
